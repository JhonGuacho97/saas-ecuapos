...
export const loginLogsActionType = {
    FETCH_LOGIN_LOGS: "FETCH_LOGIN_LOGS",
    FETCH_LOGIN_LOGS_REQUEST: "FETCH_LOGIN_LOGS_REQUEST",
    FETCH_LOGIN_LOGS_SUCCESS: "FETCH_LOGIN_LOGS_SUCCESS",
    FETCH_LOGIN_LOGS_FAILURE: "FETCH_LOGIN_LOGS_FAILURE",
    DELETE_LOGIN_LOG: "DELETE_LOGIN_LOG",
    BULK_DELETE_LOGIN_LOGS: "BULK_DELETE_LOGIN_LOGS",
};
...
export const Permissions = {
    ...
    MANAGE_LOGIN_LOGS: "manage_login_logs",
...
export const productActionType = {
    ...
    CLEAR_MAIN_PRODUCT: "CLEAR_MAIN_PRODUCT",
};
...
export const loginStatusOptions = [
    ...
    { id: "success", name: "login.status.success" },
    { id: "failed", name: "login.status.failed" },
];
